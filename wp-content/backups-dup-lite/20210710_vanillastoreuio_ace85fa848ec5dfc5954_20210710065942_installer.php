...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210710_vanillastoreuio_ace85fa848ec5dfc5954_20210710065942_archive.zip';
	const ARCHIVE_SIZE		 = '191711560';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'ace85fa-10065942';
    const SECONDARY_PACKAGE_HASH = 'fc0d161-10065942';
	const VERSION			 = '1.4.2';
